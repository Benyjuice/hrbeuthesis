...
% 推荐使用最新的 xelatex
%
% Tip: texlive2009 中提供了 ctex 中文支持宏包, 使用 pdflatex(TODO), dvipdfmx(TODO) 和 xelatex 时, Linux 用户已经无需进行大量中文配置
%
% TODO: 目前只测试了 xelatex
...
% 定义 xelatex 的中间临时变量, 若 \usewhat 为 xelatex 时, 后面将执行 xelatx 的相关选项
% 使用到这个变量的文件有:
%   main.tex
...
% Tip: 哈工程本科论文规定使用单面打印
%
% setup/type.tex 中已有完整定义, 此处不定义也可
% 
...
% 引入的宏包  % TODO TODO TODO TODO TODO
...
\fontsize{12pt}{12pt}\selectfont
\ifxueweidoctor       % 本科和硕士学位论文没有英文目录
