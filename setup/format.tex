...
%\contentsmargin{1pt}
\titlecontents{chapter}[0em]{\vspace{0.5em}\hei \xiaosi}{\contentslabel{0em}}{\hspace*{0em}}{\normalfont\titlerule*[5pt]{.}\contentspage}  % \normalfont 应该是新罗马，试图将点点们调密
\dottedcontents{section}[1.40cm]{\vspace{0.5em}\xiaosi}{1.8em}{5pt}
\dottedcontents{subsection}[2.50cm]{\vspace{0.5em}\xiaosi}{2.7em}{5pt}
\dottedcontents{subsubsection}[3.60cm]{\vspace{0.5em}\xiaosi}{3.4em}{5pt}
...
\fancypagestyle{contents} {
	\fancyhf{}
	\fancyhead[CO]{\song \xiaowu\@ctitle}
	\fancyhead[CE]{\song \xiaowu 哈尔滨工程大学\cxueke\cxuewei 学位论文}
	\fancyfoot[C,C]{\xiaowu --~\thepage~--}	
}
...
\begin{list}{\hei (\arabic{pubctr})}  % 标签格式
    {
     \usecounter{pubctr}
...
\def\makecover{
    ...
    % 封面
    %\begin{center}
     \parbox[t][0.8cm][t]{7cm}{\hei \wuhao 分类号：\underline{\makebox[\lengthofxuehao][c]{}}\\
     \hfill U~~D~~C：\underline{\makebox[\lengthofxuehao][c]{}}~~~}
    \parbox[t][0.8cm][t]{7cm}{\hei \wuhao 密级：\underline{\makebox[\lengthofxuehao][c]{}} \\ 
    	\hfill 编号：\underline{\makebox[\lengthofxuehao][c]{}}~~~}  % \lengthofxuehao 决定了一个空横线的长度，本科论文的密级留空，即使填写，密级也比学号短，故使用学号长度
    %\end{center}
    ...
    %  \begin{center} {\song  \@cauthor}  \end{center} }
     \parbox[t][1.0cm][t]{\textwidth}{
     	\xiaosan
     	\makebox[3.0cm][c]{}
     	\makebox[6em][s]{\song 硕士研究生：}
     	\makebox[7cm][l]{\song \@cauthor}
     }
     \parbox[t][1.0cm][t]{\textwidth}{
     	\xiaosan
     	\makebox[3.0cm][c]{}
     	\makebox[6em][s]{\song 指导老师：}
     	\makebox[7cm][l]{\song \@csupervisor}
     }
     \parbox[t][1.0cm][t]{\textwidth}{
     	\xiaosan
     	\makebox[3.0cm][c]{}
     	\makebox[6em][s]{\song 学科、专业：}
     	\makebox[7cm][l]{\song \@csubject}
     }
     \parbox[t][1.0cm][t]{\textwidth}{
     	\xiaosan
     	\makebox[3.0cm][c]{}
     	\makebox[6em][s]{\song 论文主审人：}
     	\makebox[7cm][l]{\song \@csupervisor}
     }
    \fi
    ...
    \parbox[t][0.8cm][t]{7cm}{\hei \wuhao 分类号：\underline{\makebox[\lengthofxuehao][c]{}}\\
    	\hfill U~~D~~C：\underline{\makebox[\lengthofxuehao][c]{}}~~~}
    \parbox[t][0.8cm][t]{7cm}{\hei \wuhao 密级：\underline{\makebox[\lengthofxuehao][c]{}} \\ 
    	\hfill 编号：\underline{\makebox[\lengthofxuehao][c]{}}~~~}
    \begin{center}
    ...
    \parbox[t][1.0cm][t]{\textwidth}{
      \sihao
      \makebox[3.6cm][c]{}
      \makebox[7em][s]{\song \textbf {硕士研究生：}}
      \makebox[7cm][l]{\song \@cauthor}
    }
    \parbox[t][1.0cm][t]{\textwidth}{
      \sihao
      \makebox[3.6cm][c]{}
      \makebox[7em][s]{\song \textbf {指导教师：}}
      \makebox[7cm][l]{\song \@csubject}
    }
    \parbox[t][1.0cm][t]{\textwidth}{
      \sihao
      \makebox[3.6cm][c]{}
      \makebox[7em][s]{\song \textbf {学位级别：}}
      \makebox[7cm][l]{\song \xuehao}
    }
    \parbox[t][1.0cm][t]{\textwidth}{
      \sihao
      \makebox[3.6cm][c]{}
      \makebox[7em][s]{\song \textbf {学科、专业：}}
      \makebox[7cm][l]{\song \@cauthor}
    }
    \parbox[t][1.0cm][t]{\textwidth}{
      \sihao
      \makebox[3.6cm][c]{}
      \makebox[7em][s]{\song \textbf {所在单位：}}
      \makebox[7cm][l]{\song \@csupervisor}
    }
    \parbox[t][1.0cm][t]{\textwidth}{
    	\sihao
    	\makebox[3.6cm][c]{}
    	\makebox[7em][s]{\song \textbf {论文提交日期：}}
    	\makebox[7cm][l]{\song \xuehao}
    }
    \parbox[t][1.0cm][t]{\textwidth}{
    	\sihao
    	\makebox[3.6cm][c]{}
    	\makebox[7em][s]{\song \textbf {论文答辩日期：}}
    	\makebox[7cm][l]{\song \xuehao}
    }
    \parbox[t][1.0cm][t]{\textwidth}{
    	\sihao
    	\makebox[3.6cm][c]{}
    	\makebox[7em][s]{\song \textbf{学位授予单位：}}
    	\makebox[7cm][l]{\song \xuehao}
    }
 ...
 %% 硕士论文英文扉页和原创性声明
    ...
    \begin{center} \renewcommand{\arraystretch}{1.5}
    	\parbox[t][1.0cm][t]{\textwidth}{
    		\sihao
    		\makebox[3.6cm][c]{}
    		\makebox[7em][r]{\song \textbf {Candidate：}}
    		\makebox[7em][l]{\song \@eauthor}
    	}
    	\parbox[t][1.0cm][t]{\textwidth}{
    		\sihao
    		\makebox[3.6cm][c]{}
    		\makebox[7em][r]{\song \textbf {Supervisor：}}
    		\makebox[7em][l]{\song \@esupervisor}
    	}
    	\parbox[t][1.0cm][t]{\textwidth}{
    		\sihao
    		\makebox[3.6cm][c]{}
    		\makebox[7em][r]{\song \textbf {Academic Degree Applied for：}}
    		\makebox[7em][l]{\song \@edegree}
    	}
    	\parbox[t][1.0cm][t]{\textwidth}{
    		\sihao
    		\makebox[3.6cm][c]{}
    		\makebox[7em][r]{\song \textbf {Specialty：}}
    		\makebox[7em][l]{\song \@esubject}
    	}
    	\parbox[t][1.0cm][t]{\textwidth}{
    		\sihao
    		\makebox[3.6cm][c]{}
    		\makebox[7em][r]{\song \textbf {Date of Submission:}}
    		\makebox[7em][l]{\song \@edate}
    	}
    	\parbox[t][1.0cm][t]{\textwidth}{
    		\sihao
    		\makebox[3.6cm][c]{}
    		\makebox[7em][r]{\song \textbf {Date of Oral Examination：}}
    		\makebox[7em][l]{\song \@edate}
    	}
    	\parbox[t][1.0cm][t]{\textwidth}{
    		\sihao
    		\makebox[3.6cm][c]{}
    		\makebox[7em][r]{\song \textbf {University:}}
    		\makebox[7em][l]{\song Harbing Engineering University}
    	}
    \end{center}}}
