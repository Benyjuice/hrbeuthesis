...
\fi
\ifxueweimaster % TODO
  \usepackage[top=28true mm, bottom=28true mm, left=25true mm, right=25true mm,
              headheight=20mm, headsep=4mm, footskip=8mm,
              bindingoffset=0 pt
              ]{geometry}
\fi
\ifxueweidoctor % TODO
...
\ADLinactivate %与tabu冲突用到时，再用\ADLinactivate启用
